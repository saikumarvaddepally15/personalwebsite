...
export default function Slidebar() {
  ...
  return (
    <div className="flex-none  bg-white h-screen min-w-[25%] fixed">
      <div className="nav flex  text-white text-lg mt-10 flex-col align-middle justify-center text-center w-full gap-5 overflow-hidden">
        <div data-aos="slide-down">
          <img
            ...
            alt="Sai Kumar Vaddepally"
            className="rounded-full border-solid cursor-pointer  border-stone-600 min-h-fit mx-auto  max-w-[190px]"
          />
          <h3 className="text-black name py-4 font-medium ">
          <b>Sai Kumar Vaddepally</b>
          </h3>
        </div>
        <p
          onClick={() => setSelect(0)}
      ...
      >
        <div
          onClick={() =>
            window.open("https://github.com/saikumarvaddepally15", "_blank")
          }
        >
        ...
        <div
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/vaddepally-sai-kumar/",
              "_blank"
            )
          }
        >
